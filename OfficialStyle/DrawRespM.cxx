...
public:
	...
	void DrawAll()
	{
		this->Draw( this->h_respM_detRes, "detRes" );
		this->Draw( this->h_respM_FSR, "FSR" );
	}

private:
	void Draw( TH2D* h_respM, TString type )
	{
		gStyle->SetOptStat(0);
		...
		TString canvasName = this->channel+"_respM_"+type;
	...
	void Init()
	{
		if( this->channel == "Muon" )
		{
			...
			this->h_respM_detRes = this->CalcFractionPerBin_Transpose( h_nEvents_detRes, h_truth_detRes );
