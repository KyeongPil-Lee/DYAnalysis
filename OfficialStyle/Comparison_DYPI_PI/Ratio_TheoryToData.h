...
public:
	...
	void Draw_Below200GeV()
	{
		...
		TLegend *legend2;
		SetLegend( legend2, 0.15, 0.75, 0.60, 0.85 );
	...
	void Draw_Above200GeV()
	{
		...
		TLegend *legend2;
		SetLegend( legend2, 0.15, 0.65, 0.60, 0.85 );
		legend2->AddEntry( h_ratio_noPI_temp, "Theory(FEWZ, w/o PI)/Data");
		legend2->AddEntry( h_ratio_withPI_temp, "Theory(FEWZ, w/ PI)/Data");
		legend2->Draw();
...
protected:
	...
	void DrawLatexNDC( TLatex &latex )
	{
		...
		if( this->Type == "Muon" )
		{
			...
			latex.DrawLatexNDC(0.76, 0.91, "#font[42]{#scale[0.8]{#gamma*/Z #rightarrow #mu^{+}#mu^{-}}}");
		}
		else if( this->Type == "Electron" )
		{
			latex.DrawLatexNDC(0.74, 0.96, "#font[62]{#scale[0.7]{2.3 fb^{-1} (13 TeV)}}");
			latex.DrawLatexNDC(0.76, 0.91, "#font[42]{#scale[0.8]{#gamma*/Z #rightarrow e^{+}e^{-}}}");
		}
		else if( this->Type == "Combined" )
		{
			...
			latex.DrawLatexNDC(0.68, 0.91, "#font[42]{#scale[0.8]{#gamma*/Z #rightarrow e^{+}e^{-}, #mu^{+}#mu^{-}}}");
		}
	}
