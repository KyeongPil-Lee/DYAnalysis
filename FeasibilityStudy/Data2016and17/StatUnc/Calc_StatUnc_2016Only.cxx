...
{
	Double_t lumi_2016 = 35863.818;
	Double_t lumi_2017 = 41526.280;
	...
	for(Int_t i=0; i<nBin; i++)
	{
		...
		// -- scale to 2016 only
		nEvent = nEvent * (lumi_2016 / (lumi_2016+lumi_2017) );
...
{
	TFile *f_output = TFile::Open("ROOTFile_RelStatUnc_2016_"+Flavor+".root", "RECREATE");
