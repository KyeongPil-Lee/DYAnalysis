...
public:
	...
	UncTool2016_1D()
	{
		...
		this->FileName_2015 = ROOTFilePath + "/ROOTFile_DiffXSec_FullUnc.root";
		this->HistName_2015_Stat = "h_RelStatUnc_Percent";
		this->HistName_2015_EffSF = "h_RelSysUnc_Eff.SF._Percent";
		this->HistName_2015_DetRes = "h_RelSysUnc_Det.Res_Percent";
		this->HistName_2015_Bkg = "h_RelSysUnc_Bkg.Est._Percent";
		this->HistName_2015_FSR = "h_RelSysUnc_FSR_Percent";
		this->HistName_2015_Syst = "h_RelSysUnc_Tot_Percent";
	...
	void Save_All()
	{
		TFile *f_output = TFile::Open("ROOTFile_ExpectedUnc_1D.root", "RECREATE");
...
protected:
	void DrawSummaryPlot()
	{
		...
		TCanvas *c;
		TString CanvasName = "Local/Summary_2016Unc_1D";
	...
	{
		TH1D* h_RelUnc_2015 = Get_Hist( this->FileName_2015, this->HistName_2015_Syst );
	...
	void DrawComparisonPlot( TH1D* h_2015, TH1D* h_2016, TString Type )
	{
		...
		TString CanvasName = "Local/2015_vs_2016_"+Type;
	...
	void SetUncHist_Stat()
	{
		...
		TString FileName = AnalyzerPath+"/FeasibilityStudy/Data2016/StatUnc/ROOTFile_RelStatUnc_2016_Muon.root";
	...
	{
		TH1D* h_RelUnc_2015 = Get_Hist( this->FileName_2015, this->HistName_2015_DetRes );
	...
	void SetUncHist_Bkg()
	{
		TH1D* h_RelUnc_2015 = Get_Hist( this->FileName_2015, this->HistName_2015_Bkg );
		h_RelUnc_2015->Scale( this->LumiScale_Stat );
	...
	{
		TH1D* h_RelUnc_2015 = Get_Hist( this->FileName_2015, this->HistName_2015_EffSF );
