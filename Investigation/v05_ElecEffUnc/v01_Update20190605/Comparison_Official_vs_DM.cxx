...
private:
  ...
  void ComparisonwRatio_GivenPtBin(Int_t i_pt)
  {
    ...
    if( effType_ == "reco" ) titleX = "#eta(e)";
    if( effType_ == "ID" )   titleX = "|#eta(e)|";
    canvas->SetTitle(titleX, "Value", "DM/official");
    ...
    if( effType_ == "reco" && type_.Contains("eff_") ) canvas->SetRangeRatio(0.86, 1.14);
    if( effType_ == "ID"   && type_.Contains("eff_") ) canvas->SetRangeRatio(0.94, 1.06);
  ...
  void Init_DM()
  {
    ...
    if( effType_ == "reco" ) fileName = "ROOTFile_RecoSF_05June2019.root";
    if( effType_ == "ID" )   fileName = "ROOTFile_IDSF_05June2019.root";
