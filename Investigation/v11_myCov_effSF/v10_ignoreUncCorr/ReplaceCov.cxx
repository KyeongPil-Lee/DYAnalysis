TMatrixD GetAndConvert_TH2DtoMatrix(TString theUncType)
{
  ...
  TString covFilePath = analyzerPath+TString::Format("/ElecChannel/CovMatrix/EfficiencySF/v10_ignoreUncCorr/%s/ROOTFile_CovM_EfficiencySF.root", theUncType.Data());
...
void ReplaceCov(TString theUncType)
{
  ...
  TString fileName_new = TString::Format("./ROOTFile_Input_Covs_v19_20190725_myCov_effSFSyst_ignoreUncCorr_in_%s.root", theUncType.Data());
