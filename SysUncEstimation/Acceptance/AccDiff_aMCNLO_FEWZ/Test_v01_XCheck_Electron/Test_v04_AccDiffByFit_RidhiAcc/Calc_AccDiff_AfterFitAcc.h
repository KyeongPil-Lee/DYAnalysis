...
protected:
	...
	void Get_Histogram()
	{
		...
		else if( this->TStr_Channel == "Electron" )
		{
			...
			TString FileName_Ridhi = this->AnalyzerPath+"/SysUncEstimation/Acceptance/AccDiff_aMCNLO_FEWZ/Test_v01_XCheck_Electron/Test_v01_XCheck_Ridhi/DYEE_AccEff_M10to3000.root";
			...
			this->h_Acc_aMCNLO = Convert_GraphToHist( g_Ridhi );

			TString FileName_FEWZ = this->AnalyzerPath+"/SysUncEstimation/Acceptance/AccDiff_aMCNLO_FEWZ/Test_v01_XCheck_Electron/ROOTFile_Acc_Electron_FEWZ_PDF4LHC15.root";
