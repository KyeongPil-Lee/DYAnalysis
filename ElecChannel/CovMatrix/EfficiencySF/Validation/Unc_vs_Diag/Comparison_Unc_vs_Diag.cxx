...
void Comparison_givenUncType(TString uncType)
{
  ...
  // -- estimated with the central value calculated using the old efficiency value ... small differences are expected
  TString fileName_relUnc = analyerPath+"/SysUncEstimation/EfficiencyScaleFactor/TagProbeMethod/ElecChannel/ROOTFile_SystUnc_TagProbeMethod_ElecChannel.root";
  TString histName_relUnc = "";
  if( uncType == "stat" ) histName_relUnc = "h_relUnc_stat";
  else                    histName_relUnc = "h_relUnc_syst_"+uncType;
