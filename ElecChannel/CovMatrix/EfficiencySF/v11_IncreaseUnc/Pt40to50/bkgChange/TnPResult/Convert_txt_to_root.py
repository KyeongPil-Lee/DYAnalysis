...
class Converter:
    ...
    def MakeHistogramAndSave(self, list_dic):
        ...
        self.ModifyEffToSyncDiff_Pt40to50_Pt30to40(h_eff_data, h_eff_bkgChange_data)
    ...
    def ModifyEffToSyncDiff_Pt40to50_Pt30to40(self, h_eff_cen, h_eff_alt):
        i_Pt30to40 = 2
        i_Pt40to50 = 3

        i_Pt30to40Bin = i_Pt30to40+1
        i_Pt40to50Bin = i_Pt40to50+1

        nEtaBin = h_eff_cen.GetNbinsX()
        for i_eta in range(0, nEtaBin):
            i_etaBin = i_eta+1

            eff_cen_Pt30to40 = h_eff_cen.GetBinContent(i_etaBin, i_Pt30to40Bin)
            eff_alt_Pt30to40 = h_eff_alt.GetBinContent(i_etaBin, i_Pt30to40Bin)

            diff_Pt30to40 = eff_alt_Pt30to40 - eff_cen_Pt30to40

            eff_cen_Pt40to50 = h_eff_cen.GetBinContent(i_etaBin, i_Pt40to50Bin)
            eff_alt_Pt40to50_new = diff_Pt30to40 + eff_cen_Pt40to50 # -- to have same diff: diff_Pt40to50 = diff_Pt30to40

            h_eff_alt.SetBinContent(i_etaBin, i_Pt40to50Bin, eff_alt_Pt40to50_new)
...
# converter_SMP17001_reco = Converter()
# converter_SMP17001_reco.inputFile = baseDir+"/RECO.txt"
# converter_SMP17001_reco.outputFileName = "ROOTFile_RecoSF_SMP17001.root"
# converter_SMP17001_reco.list_etaBinEdge = [-2.5, -2.0, -1.566, -1.4442, -0.800, 0, 0.800, 1.4442, 1.566, 2.0, 2.5]
# converter_SMP17001_reco.list_ptBinEdge = [10, 20, 30, 40, 50, 2000]
# converter_SMP17001_reco.list_columnTitle = ["etaMin", "etaMax", "ptMin", "ptMax", "eff_data", "statUnc_data", "eff_mc", "statUnc_mc", "eff_bkgChange_data", "eff_sgnChange_data", "eff_nlo_mc", "eff_tagChange_mc"]

# converter_SMP17001_reco.Convert()

# # -- official (SMP-17-001), ID
# converter_SMP17001_ID = Converter()
# converter_SMP17001_ID.inputFile = baseDir+"/MediumID.txt"
# converter_SMP17001_ID.outputFileName = "ROOTFile_IDSF_SMP17001.root"
# converter_SMP17001_ID.list_etaBinEdge = [-2.5, -2.0, -1.566, -1.4442, -0.800, 0, 0.800, 1.4442, 1.566, 2.0, 2.5]
# converter_SMP17001_ID.list_ptBinEdge = [10, 20, 30, 40, 50, 2000]
# converter_SMP17001_ID.list_columnTitle = ["etaMin", "etaMax", "ptMin", "ptMax", "eff_data", "statUnc_data", "eff_mc", "statUnc_mc", "eff_bkgChange_data", "eff_sgnChange_data", "eff_nlo_mc", "eff_tagChange_mc"]

# converter_SMP17001_ID.Convert()
