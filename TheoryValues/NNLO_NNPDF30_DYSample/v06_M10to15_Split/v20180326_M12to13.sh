...
echo "run: ./local_run.sh z v20180326_M12to13 v20180326_M12to13_param.txt v20180326_M12to13_hist.txt v20180326_M12to13.dat ../ 24"
./local_run.sh z v20180326_M12to13 v20180326_M12to13_param.txt v20180326_M12to13_hist.txt v20180326_M12to13.dat ../ 24

echo "run: ./finish.sh v20180326_M12to13 NNLO.v20180326_M12to13.dat"
./finish.sh v20180326_M12to13 NNLO.v20180326_M12to13.dat
